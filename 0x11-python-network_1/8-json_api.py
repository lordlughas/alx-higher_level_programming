...
and creates a payload with it.It then makes a POST
request to the endpoint "http://0.0.0.0:5000/search_user"
with the payload.It then tries to parse the response into JSON,
if the response is empty it prints a message of "No result",
...
if __name__ == "__main__":
    # getting the letter from command line argument
    letter = "" if len(sys.argv) == 1 else sys.argv[1]
    # creating the payload to send in the POST request
    payload = {"q": letter}
